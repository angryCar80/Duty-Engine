...
/// <summary>
/// SDL3 platform backend for ImGui.
...
public class ImGuiSDL3 : IDisposable
{
    ...
    public bool ProcessEvent(SDL.Event e)
    {
        ...
        switch ((SDL.EventType)e.Type)
        {
            case SDL.EventType.MouseMotion:
                if (GetViewportForWindowId(e.Motion.WindowID) == null) return false;
            ...
            case SDL.EventType.MouseWheel:
                if (GetViewportForWindowId(e.Wheel.WindowID) == null) return false;
            ...
            case SDL.EventType.MouseButtonUp:
                if (GetViewportForWindowId(e.Button.WindowID) == null) return false;
                int mouseButton = -1;
                ...
                _mouseButtonsDown = ((SDL.EventType)e.Type == SDL.EventType.MouseButtonDown)
                    ? _mouseButtonsDown | (1 << mouseButton)
                    : _mouseButtonsDown & ~(1 << mouseButton);
                return true;

            case SDL.EventType.TextInput:
                if (GetViewportForWindowId(e.Text.WindowID) == null) return false;
                unsafe
                {
            ...
            case SDL.EventType.KeyUp:
                if (GetViewportForWindowId(e.Key.WindowID) == null) return false;
            ...
            case SDL.EventType.WindowMouseEnter:
                if (GetViewportForWindowId(e.Window.WindowID) == null) return false;
    ...
    private void UpdateMouseData()
    {
        ...
        if (focusedWindow == Window && io.WantSetMousePos)
    ...
    public static ImGuiViewportPtr? GetViewportForWindowId(uint id)
    {
        ...
        return (viewport.ID == id) ? viewport : null;
    }
}
